...
namespace MushROMs.SNES.SMAS.SMB1
{
    public enum ObjectType
    {
        ...
        Empty,
        Empty2,
        GreenIsland = 0x10 | ObjectMode.Trees,
        MushroomIsland = 0x10 | ObjectMode.Mushrooms,
        Cannon = 0x10 | ObjectMode.BulletBillTurrets,
        CloudGround = 0x10 | ObjectMode.CloudGround,
