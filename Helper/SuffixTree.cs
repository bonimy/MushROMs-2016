...
namespace Helper
{
    ...
    public class SuffixTree
    {
        ...
        /// <summary>
        /// Gets the number of unique nodes created to design this <see cref="SuffixTree"/>.
        /// </summary>
        ...
        /// <summary>
        /// Initializes the paremeters of this <see cref="SuffixTree"/> with a given
        /// data size.
        /// </summary>
        /// <param name="size">
        ...
        {
            // Update positiona and write new value.
            Data[++Position] = value;
        ...
        /// the substring starting at <see cref="index"/> within <see cref="Data"/>.
        ...
        private class Node
        {
            ...
            /// </summary>
            private const int AllocationSize = AlbhabetSize + 1;
            ...
            /// <summary>
            /// The <see cref="RootNode"/> that this <see cref="Node"/> belongs to.
            /// </summary>
            ...
            {
                get { return SubstringPointer.FromStartAndLength(Start, Length); }
            }
            ...
            /// whose index is in this array. This saves a substantional number of
        ...
        private class RootNode : Node
        {
            ...
            /// <summary>
            /// Derefernces <see cref="Link"/> and children in <see cref="Children"/>.
            /// </summary>
            public void Reset()
            {
                Reset(-1, -1);
        ...
        private class NodeCollection : List<Node>
        {
            ...
            /// <see cref="SuffixTree"/> as its owner.
            /// </summary>
            /// <param name="tree">
            ...
            /// </exception>
            public NodeCollection(SuffixTree tree) : this(tree, 0)
            { }
            ...
            /// <summary>
            /// Adds a <see cref="Node"/> with <see cref="Node.Start"/> set to
            /// <paramref name="position"/> and <see cref="Node.End"/> set to <paramref name="end"/>
